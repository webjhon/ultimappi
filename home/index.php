...
<body>
    ...
    <div class="row">
		...
		<div class="col-md-12">
			...
			<img id="Image-Maps-Com-mapa-categorias" src="../img/roda_link.png" border="0" width="628" height="628" orgWidth="628" orgHeight="628" usemap="#mapa-categorias" alt="" class="img-responsive center-block"/>
